...
ROOT_DIR = f"/home/hchowdhu/Documents/HiCInterpolate_Set_1"
DATA_DIR = f"/mmfs1/home/hchowdhu/data/hic_triplets/normalized"
...
UNIQUE_LEVELS = 2
FLOW_NUM_OF_CONVS = [3, 3, 3]
FLOW_OUT_CHANNELS = [16, 32, 64]
...
LOSS_WEIGHT_PARAMETERS = [
    {'name': 'charbonnier', 'boundaries': [0], 'values': [1.0, 1.0]},
    {'name': 'ssim', 'boundaries': [0], 'values': [1.0, 1.0]},
    {'name': 'vgg', 'boundaries': [600], 'values': [1.0, 0.40]},
    {'name': 'style', 'boundaries': [400], 'values': [0.0, 0.60]}]

NUM_VISUALIZATION_SAMPLES = 2
IMG_VAL_PLOT_PATH = os.path.sep.join(
    [ROOT_DIR, "output"])

MODEL_NAME = 'hicinterpolate_64'
