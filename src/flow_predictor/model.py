...
class FlowPredictor(nn.Module):
    def __init__(self, cfg, feature_channels=[32, 64, 128, 256], max_disp=4):
        ...
        self.compress_L2 = nn.Conv2d(
            feature_channels[2] + feature_channels[3], feature_channels[2], kernel_size=1)
        self.compress_L1 = nn.Conv2d(
            feature_channels[1] + feature_channels[2], feature_channels[1], kernel_size=1)
        self.compress_L0 = nn.Conv2d(
            1 + feature_channels[1], feature_channels[0], kernel_size=1)
