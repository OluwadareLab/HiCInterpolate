...
for rep in [1]:
    for i in range(1, 2):
        ...
        STRUC_FILE = "/home/hc0783.unt.ad.unt.edu/workspace/hic_interpolation/4DMax/data/results/human/dmso_control/control/0m_30m_60m/10000/21/Generated_Structures/dmso_control_control_rep_1_eta_1000_alpha_0.6_lr_0.0001_epoch_10_res_10000_step_21_chro_21.npy"
        TIME_POINTS = np.linspace(0, 30, 60)
