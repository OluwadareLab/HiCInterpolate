...
def main(config_filename: str, isDistributed: bool = False, load_snapshot: bool = False):
    ...
    os.makedirs(f"{cfg.paths.root_dir}/output/", exist_ok=True)
    os.makedirs(f"{cfg.paths.root_dir}/models/", exist_ok=True)
    ...
    trainer = TrainLib.Trainer(cfg, train_dl, val_dl,
